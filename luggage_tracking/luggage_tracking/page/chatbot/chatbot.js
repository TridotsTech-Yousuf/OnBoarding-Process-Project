...
//             <div id="chat_output" style="margin-top:20px; white-space: pre-wrap;"></div>
//         </div>
//     `);

//     $('#ask_btn').on('click', function() {
//         let question = $('#user_input').val();
//         $('#chat_output').html("⏳ Thinking...");
...
//             callback: function(r) {
//                 if (r.message) {
//                     $('#chat_output').html(`<b>You:</b> ${question}<br><b>Bot:</b> ${r.message}`);
//                 } else {
//                     $('#chat_output').html("❌ No response received.");
//                 }
//             }
//         });
//     });
